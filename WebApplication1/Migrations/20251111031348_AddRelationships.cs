        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoreMechanics = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameConcepts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameConcepts_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicalRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TechnicalRequirements_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameDesigner_Specialization = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameDesignerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BugReports_Employees_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BugReports_Employees_DeveloperId",
                        column: x => x.DeveloperId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BugReports_Employees_GameDesignerId",
                        column: x => x.GameDesignerId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BugReports_Employees_ProducerId",
                        column: x => x.ProducerId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BugReports_Employees_TesterId",
                        column: x => x.TesterId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BugReports_GameDesignerId",
                table: "BugReports",
                column: "GameDesignerId");

            migrationBuilder.CreateIndex(
                name: "IX_BugReports_ProducerId",
                table: "BugReports",
                column: "ProducerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameConcepts_ProjectId",
                table: "GameConcepts",
                column: "ProjectId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicalRequirements_ProjectId",
